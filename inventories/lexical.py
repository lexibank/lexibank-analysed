...
if "arm" in argv:
    ...
    for language in sorted(lexicore.languages, key=lambda x: len(x.concepts), reverse=True):
        hand_arm = fc.features["HandAndArm"](language)
        if hand_arm == 1:
            color = "red"
            zorder=100
        elif hand_arm == 0:
        ...
        try:
            ...
            print(language.dataset, language.name)
    plt.savefig("hand-and-arm.pdf", dpi=900)
...
if "finger" in argv:
    ...
    for language in sorted(lexicore.languages, key=lambda x: len(x.concepts), reverse=True):
        hand_arm = fc.features["FingerAndHand"](language)
        if hand_arm == 1:
            color = "red"
            zorder=100
        elif hand_arm == 0:
        ...
        try:
            ...
            print(language.dataset, language.name)
    plt.savefig("finger-and-hand.pdf", dpi=900)
...
if "foot" in argv:
    ...
    for language in sorted(lexicore.languages, key=lambda x: len(x.concepts), reverse=True):
        hand_arm = fc.features["LegAndFoot"](language)
        if hand_arm == 1:
            color = "red"
            zorder=100
        elif hand_arm == 0:
        ...
        try:
            ...
            print(language.dataset, language.name)
    plt.savefig("leg-and-foot.pdf", dpi=900)
